                ...
                <div id="main">
                    ...
                    <div class="sidebar">
                        ...
                        <div class="sidebar_content">
                            ...
                            <ul id="sub_menu">
                                <li><a href="http://hansujasolutions.com/solutions.html">Website Design and
                                        Development</a>
                                </li>
                                ...
                                <li><a href="http://hansujasolutions.com/hosting.html">Domain Name Registrations</a>
                                </li>
                                <li><a href="http://hansujasolutions.com/logo.html">Corporate Logos</a></li>
                                <li><a href="http://hansujasolutions.com/solutions.html">Web Marketing Consulting</a>
                                </li>
                                <li><a href="http://hansujasolutions.com/ecommerce.html">E-Commerce Applications</a>
                                </li>
                                ...
                                <li><a href="http://hansujasolutions.com/online-marketing.html">Online Marketing</a>
                                </li>
                            ...
                            <div class="box middle">
                                <div class="imgarea">
                                    <!-- box 1 image -->
                                    <a href="http://hansujasolutions.com/web-design.html"><img
                                            src="images/webservices.png" width="220" height="137" class="image"
                                            alt="Web Services" /></a>
                                </div>
                                <div class="textarea">
                                    <!-- box title-->
                                    <h3 class="shadow"><a href="http://hansujasolutions.com/content.html">CMS /
                                            Portals</a>
                                    </h3>
                                    <div align="justify">
                                        <!-- text-->
                                        ...
                                        distribution,
                                        publishing, and discovery of corporate information.It covers the complete
                                        lifecycle
                                        of
                                        the pages on your site, from providing simple tools to create the content,
                                        through
                                        to
